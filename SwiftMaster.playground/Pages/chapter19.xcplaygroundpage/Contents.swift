...
//convertedVal = 5.5 // error

var stringVal: String = "123"
var integerVal: Int? = Int(stringVal)
...
print(integerVal) // nil == Optional.none
print()
...
if let _: Americano = coffee as? Americano {
    print("This is Americano")
} else {
    print(coffee.description)
}

if let _: Latte = coffee as? Latte {
    print("This is Latte")
} else {
    print(coffee.description)
}

if let _: Coffee = coffee as? Coffee {
    print("This is Just Coffee")
} else {
    print(coffee.description)
}

if let _: Americano = myCoffee as? Americano {
    print("This is Americano")
} else {
    print(coffee.description)
}

if let _: Latte = myCoffee as? Latte {
    print("This is Latte")
} else {
    print(coffee.description)
}

if let _: Coffee = myCoffee as? Coffee {
    print("This is Just Coffee")
} else {
    print(coffee.description)
}
...
func castTypeToAppropriate(item: AnyObject) {
    if let castedItem: Coffee = item as? Coffee {
...
let optionalVal: Int? = 100
print(optionalVal)
print(optionalVal as Any)
